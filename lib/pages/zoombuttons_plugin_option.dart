          ...
          Padding(
            ...
            child: FloatingActionButton(
              ...
              onPressed: () {
                ...
                log("current zoom"+centerZoom.zoom.toString());

                var zoom = centerZoom.zoom + 1;
                if (zoom < zoomButtonsOpts.minZoom) {
                  log("zoom less than "+zoomButtonsOpts.minZoom.toString());
                  var zoom = zoomButtonsOpts.minZoom as double ;
                  log("setting zoom to $zoom");
                } else {
                  log("zoomming into zoom level $zoom");
